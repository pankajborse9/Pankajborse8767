...
TOKEN = '7212165431:AAEvk6Veml7O7PKWFjyqxtraTy1GqHvd3cc'
MONGO_URI = 'mongodb+srv://Soul:JYAuvlizhw7wqLOb@soul.tsga4.mongodb.net'
FORWARD_CHANNEL_ID = -1002171470008
CHANNEL_ID = -1002171470008
error_channel_id = -1002171470008
...
def approve_or_disapprove_user(message):
    ...
    if action == '/approve':
        ...
        msg_text = (f"*🎉 Congratulations!*\n"
                    ...
                    f"*Welcome to our community! server की मां बहन करने की शक्तियां इनको मिल चुकी है✨*")
    else:  # disapprove
        users_collection.update_one(
            {"user_id": target_user_id},
        ...
        msg_text = (f"*❌ Disapproval Notice!*\n"
                    ...
                    f"*इन भाई साहब से शक्तियां छीन चुकी है*\n"
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*🚫 Access Denied!*\n"  # Access Denied message
                                       "*कहा घुसा जा रहा है फ्री का maal समझा हैं क्या*\n"  # Need approval message
                                       "*bot के मालिक से बात करले एक बार: @jai_05.*", parse_mode='Markdown')  # Contact owner message
            return
        ...
        bot.send_message(chat_id, "*💣 मां चोद दो server की *\n"  # Ready to launch message
...
def myinfo_command(message):
    ...
    if not user_data:
        ...
        response += "*For assistance, please contact the owner: @jai_05* "  # Contact owner message
    elif user_data.get('plan', 0) == 0:
        # User found but not approved
        response = "*🔒 Your account is still pending approval!* \n"  # Not approved message
        response += "*Please reach out to the owner for assistance: @jai_05* 🙏"  # Contact owner message
    else:
